...
export const ResumeLayout = () => {
    ...
    return (
        <div
            className="min-h-screen flex p-3 sm:p-5 bg-cover bg-center"
            style={{ backgroundImage: `url(${bgImage})` }}
        >
            <div className="w-full bg-blue-50 rounded-2xl shadow-md p-3 sm:p-5 flex flex-col">

                {/*small screens */}
                <div className="flex lg:hidden mb-3 bg-white rounded-xl p-1 shadow-sm">
                    <button
                ...
                {/* MAIN GRID */}
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-4 sm:gap-6 flex-1 min-h-0">
